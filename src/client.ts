...
import {
  ...
  APIResponseKnowledgeBaseFileOperation,
  APIResponseKnowledgeBaseList,
  APIResponseMoveKnowledgeBaseFiles,
...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['LOBEHUB_SIT_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['LOBEHUB_SIT_LOG'] or 'warn' if it isn't set.
   */
...
export class LobehubSit {
  ...
  constructor({
    ...
    this.timeout = options.timeout ?? LobehubSit.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('LOBEHUB_SIT_LOG'), "process.env['LOBEHUB_SIT_LOG']", this) ??
      defaultLogLevel;
  ...
  static LobehubSit = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static LobehubSitError = Errors.LobehubSitError;
...
LobehubSit.Agents = Agents;
LobehubSit.Files = Files;
LobehubSit.Messages = Messages;
LobehubSit.MessageTranslations = MessageTranslations;
LobehubSit.Models = Models;
LobehubSit.Permissions = Permissions;
LobehubSit.Providers = Providers;
LobehubSit.Roles = Roles;
