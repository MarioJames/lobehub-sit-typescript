import fs from 'fs';
import type { ResponseLike } from 'lobehub-sit/internal/to-file';
import { toFile } from 'lobehub-sit/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('lobehub-sit/core/uploads');
    await expect(
